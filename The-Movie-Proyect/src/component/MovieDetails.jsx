  ...
  useEffect(() => {
    ...
    const fetchMovieDetails = async () => {
      try {
        ...
        const res = await fetch(`https://api.themoviedb.org/3/movie/${id}?language=es-ES&api_key=430bfb8ead0cc8146e757cfa6600f723`);
      ...
      {movieDetails ? (
        <div className='container-moviesdetails' >
          ...
          <div className='container-descriptions'> 
            ...
            <p className='text'>Valoracion: <span> {movieDetails.vote_average} <span className='likes'><BiLike /></span></span> </p>
